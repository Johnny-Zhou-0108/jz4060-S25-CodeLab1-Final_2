...
public class DialogueVariables
{
    ...
    {
        if (globalVariablesStory != null && globalVariablesStory.variablesState != null)
        {
            return globalVariablesStory.variablesState[variableName];
        }

        Debug.LogWarning($"Variable '{variableName}' not found or story not initialized.");
        return null;
    }
