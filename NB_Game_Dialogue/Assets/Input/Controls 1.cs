...
public partial class @Controls1: IInputActionCollection2, IDisposable
{
    ...
    ~@Controls1()
    {
        UnityEngine.Debug.Assert(!m_game.enabled, "This will cause a leak and performance issues, Controls1.game.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_Newactionmap.enabled, "This will cause a leak and performance issues, Controls1.Newactionmap.Disable() has not been called.");
    }
    ...
    public struct GameActions
    {
        ...
        public GameActions(@Controls1 wrapper) { m_Wrapper = wrapper; }
